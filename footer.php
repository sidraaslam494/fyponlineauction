                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 offset-xl-1 col-md-6 col-sm-6">
                                            ...
                                            <div class="block-contact-text">
                                                <p> E-Auction<br>2nd Floor, Department of Computer Science, Faisalabad.<br>Pakistan</p>
                                                <p>Call us: <span>+92-1234567 </span></p>
                                                <p>Email us: <span>example@abc.com</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
