                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="hot-line-area">
                                    <div class="phone">
                                        Customer Support: <span>+92-1234567 </span>
                                    </div>
                                </div>
                                <!-- hot-line-area end -->
...
<div class="slider-main-area">
	<div class="slider-active owl-carousel">
		...
		<div class="slider-wrapper" style="background-image:url(img/slider/bidbanner1.png);width: 100%;">
			<div class="container-fluid">
				<div class="row">
					<div class="col">
		...
		<!-- slider-wrapper end -->
		<!-- slider-wrapper start -->
		<div class="slider-wrapper" style="background-image:url(img/slider/bidbanner2.png);width: 100%;">
			<div class="container-fluid">
				<div class="row">
					<div class="col">
						<div class="slider-text-info style-2 text-center slider-text-animation">
		...
		<!-- slider-wrapper end -->
		<!-- slider-wrapper start -->
		<div class="slider-wrapper" style="background-image:url(img/slider/bidbanner3.png);width: 100%;">
			<div class="container-fluid">
				<div class="row">
					<div class="col">
						<div class="slider-text-info style-2 text-center slider-text-animation">
